import{T as e,a as t,i as n,n as r,o as i,r as a,s as o,t as s}from"./assets/lit-Bu_JRvTe.js";import{LLMVisionPreviewCard as c,a as l,i as u,n as d,r as f,t as p}from"./llmvision-preview-card.js?v2";var m=e((()=>{i(),u(),s(),f(),p();var e=class extends r{static get properties(){return{_config:{type:Object}}}setConfig(e){this._config=e||{}}render(){if(!this._config)return a`<div>Please configure the card.</div>`;let e=this._getSchema(),t=e.slice(0,3),n=e.slice(3,6),r=e.slice(6,8),i=e.slice(8);return a`
            <style>
